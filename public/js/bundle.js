...
exports.showAlert = exports.hiddeAlert = void 0;

var hiddeAlert = function hiddeAlert() {
  var el = document.querySelector('.alert'); // dom manipulation para remover o elemento

  if (el) el.parentElement.removeChild(el);
}; //type is 'success' or 'error'


exports.hiddeAlert = hiddeAlert;

var showAlert = function showAlert(type, msg) {
  hiddeAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // INSERIR NO COMEÇO DO BODY
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged in successfully!'); // Redireciona para a homepage apos o login
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') window.setTimeout(function () {
              location.assign('/');
            }, 100);
            _context2.next = 11;
            break;
...
var displayMap = function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LngLatBounds(); //Area that will be displayed on the map

  locations.forEach(function (loc) {
    //Create marker
    var el = document.createElement('div'); // Esta no estilo do Jonas

    el.className = 'marker'; //Add new marker
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, "</p>: ").concat(loc.description)).addTo(map); //Extends map bounds to include current location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(data);
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // Muda primeira letra para maiuscula
            // stackoverflow
          ...
          case 6:
            result = _context.sent;
            if (result.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type.capitalize(), " Updated successfully!"));
            _context.next = 13;
            break;
...
var stripe = Stripe("pk_test_51I8pHxDST78sZgTkylrfANeg6yJBeL2uRd1DD01BWsCeURengotC0xg9Ba5fbF7OjT2e4VLI29MB90aLQOORNK9N00Jjk9MT9Q");
...
var userDataElement = document.querySelector('.form-user-data');
var userDataPasswordForm = document.querySelector(".form-user-settings");
...
if (userDataElement) {
  userDataElement.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // Recriando estrutura enctype='multipart/form-data'
...
if (userDataPasswordForm) {
  userDataPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //Nesse caso o await foi utilizado para esperar a troca e realizar
